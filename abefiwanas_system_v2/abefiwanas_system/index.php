...
<div class="" style>
  <img class="mySlides w3-opacity" src="sources/ads01.png" style="width:100%">
  <img class="mySlides w3-opacity" src="sources/ads02.png" style="width:100%">
  <img class="mySlides w3-opacity" src="sources/ads03.png" style="width:100%">
  <img class="mySlides w3-opacity" src="sources/ads04.png" style="width:100%">
  <img class="mySlides w3-opacity" src="sources/ads05.png" style="width:100%">
...
<!-- SEARCHING -->
    <div class="banner w3-center">
      ...
      <div>
        <a href="purchase_searching.php" class="w3-button w3-round-xlarge w3-round" style="background: #FFBF00; margin-bottom:10px" >Find Now!</a><br>
...
<div class=" w3-round-xlarge" style="margin:0 auto; width: 80%"> 
  <div class="" style="text-align:center">
    <h2>Recommended for you</h2><hr color="#FFBF00" size="8%">
  </div>

  <div class="w3-container w3-center">

    <div class="w3-third w3-container w3-round-xlarge w3-card w3-border w3-center" >
    <a href="purchase_listing.php?search=proton">
      <h3 class="w3-center"><br><b>Popular Car Listing</b><br></h3>
      <div class="w3-container w3-center" style="height:180px">
        <img src="sources/popularcar.png" >
      </div>
    ...
    <a href="purchase_listing.php?search=perodua">
      ...
      <div class="w3-container" style="height:180px">
        <img  src="sources/bestcar.png" >
      </div>
  ...
  <div class="w3-third w3-container w3-round-xlarge w3-card w3-border w3-center" >
    ...
    <a href="purchase_listing.php?search=toyota">
      ...
      <div class="w3-container" style="height:180px;">
        <img  src="sources/j2.png" style="height:105px;margin-top:40px">
      </div>
